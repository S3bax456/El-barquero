...
export const DEFAULT_MENU_DATA: Category[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { nombre: "Cebiche de pescado con langostinos", descripcion: "trozos de pescado y langostinos", precio: "S/. 48.00" }
    ]
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { nombre: "Corvina Frita", descripcion: "600 gr.", precio: "S/. 69.90", imagen: "/corvina-frita.webp" },
  ...
  },
  {
    ...
    items: [
      { nombre: "Tacu Tacu con Filete de Pescado", precio: "S/. 38.00" },
